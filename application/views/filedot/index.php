...
<div class="row">
    <div class="col-xs-12">
        <div class="alert alert-block alert-success">
            ...
            Note: Default results are overtimes filed within the last 72 hours. 
        </div>
    </div>
</div>
<?php echo form_open($action='/filedot',$attributes = array('class' => 'class=form-horizontal', 
...
<div class="row">
    <?php echo is_variable_set($subordinates); ?>
</div>
