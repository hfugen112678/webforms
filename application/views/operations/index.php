...
<div class="row">
    <div class="col-xs-12">
        <div class="alert alert-block alert-success">
            ...
            Note: An overtime that is 
            <strong class="green">less than 1 hour will not be included</strong> 
            in the search results. 
        </div>
    </div>
</div>
<?php echo form_open($action='/operations',$attributes = array('class' => 'form-horizontal', 
        'role' => 'form', 'id' => 'filterot')); ?>
...
<div class="row">
    <?php echo is_variable_set($otlist); ?>
</div>
<!-- Bootstrap Modal Pop up -->
<div class="modal fade" id="updateOT" tabindex="-1">
